...
<!-- main Items here -->
<?php
if(!isset($_GET['edit'])){ // if edit is false it means that the user did not click on their "more in
 ?>
<div class="search-box">
    <label for="">Check your url here!</label>
    <form action="checker.php" method="post">
        <label for="">kongolian.tech/Portfolios/</label>
        <input class="searcn" type="text" name="search" placeholder="url...">
        <button type="submit" name="submit">Search</button>
        <!-- <button class="btn btn-primary" type="button"><a href="checker.php?url=<?php echo $row['email']; ?>">More Info </a></button> -->
...
<div class="button-container">
    <a href="services.php" class="button button3">Back</a>
</div>
