...
<body>
    <div class="container">
        ...
        <div class="package-container">
            <div class="packages">
                <h1>Free Plan</h1>
                <h2 class="text1">&pound;0.00</h2>
                <ul class="list">
                    <li class="first"><i class="fas fa-check"></i> 1 portfolio</li>
                    <li><i class="fas fa-check"></i> 10MB storage</li>
                    <li><i class="fas fa-check"></i> Control Panel</li>
                    <li><i class="fas fa-check"></i> Support Area</li>
                    <li><i class="fas fa-check"></i> Static Site</li>
                </ul>
                <?php if (!isset($_SESSION['username'])) { ?>
                    <a href="login.php" class="button button1">Start Now</a>
                <?php } else { ?>
                    <a href="../plans/free.php" class="button button1">Start Now</a>
                <?php } ?>
            </div>
            <div class="packages">
                <h1>Pro Plan</h1>
                <h2 class="text1">&pound;1.69 / month</h2>
                <ul class="list">
                    <li class="first"><i class="fas fa-check"></i> 3 portfolio's</li>
                    <li><i class="fas fa-check"></i> 1GB storage</li>
                    <li><i class="fas fa-check"></i> Control Panel</li>
                    <li><i class="fas fa-check"></i> Support Area</li>
                    <li><i class="fas fa-check"></i> Dynamic Site</li>
                    <!-- <li class="discord"><i class="fas fa-check"></i> Free Discord Bot Hosting</li> -->
                </ul>
                <?php if (!isset($_SESSION['username'])) { ?>
                    <a href="login.php" class="button button2">Start Now</a>
                <?php } else { ?>
                    <a href="../plans/pro.php" class="button button2">Start Now</a>
                <?php } ?>
            </div>
        </div>
    </div>
...
<div class="button-container">
    <a href="checker.php" class="button button3">Check URL availability</a>
</div>
